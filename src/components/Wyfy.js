    ...
    render() {
        return(
            <div className="wyfy-project-width">
                ...
                <p className="wrap-wyfy-text"><span className="drop-cap">M</span>y role with <strong>Wyfy</strong> was voted Team Leader in the most complex design and development project we'd ever had. Our Pitch Perfect presentation was to win the interest of four State of Tennessee Professionals, ranging in IT to marketing research.
                </p>
